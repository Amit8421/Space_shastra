    ...
    <div className="flex min-h-[calc(100vh-220px)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-[#b7cade] bg-white p-8 shadow-[0_24px_70px_rgba(31,68,107,0.16)]">
        <div className="mb-7 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-[#37658f]">InteriorOps Suite</p>
          <h1 className="mt-3 text-2xl font-bold text-[#173b5d]">Interior Management Solution</h1>
          <p className="mt-2 text-sm text-slate-500">Sign in with your firm code, username, and password.</p>
        </div>
